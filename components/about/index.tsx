...
import GithubStatsClient from "@/components/about/github-stats.client";
            ...
            <BlurFade inView delay={0.06}>
              ...
              >
                ...
                <p className="mt-3 text-sm text-muted-foreground sm:text-base">
                  Real-time public profile snapshot for @{username} — pulled
                  live from the GitHub REST API with stars, forks, top
                  languages, and most recently pushed repositories. Cached
                  locally to respect API rate limits.
                </p>
