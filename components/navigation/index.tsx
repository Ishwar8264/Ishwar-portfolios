...
import CommandPalette from "@/components/ui/command-palette.client";
...
export default function Navbar({ config, classNames }: NavbarProps) {
  ...
  const ctaClasses =
    "portfolio-nav-cta inline-flex h-8 shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-full px-4 text-[0.78rem] font-semibold tracking-[0.02em] transition-all";
    ...
    >
      ...
      >
        <div className="flex h-14 w-full items-center justify-between gap-3 md:h-16">
          ...
          <div className="portfolio-nav-actions flex shrink-0 items-center gap-2">
            <CommandPalette />
            ...
            {config.cta ? (
              <NavAnchor
                ...
                className={cn(ctaClasses, "hidden lg:inline-flex")}
              />
            ) : null}
