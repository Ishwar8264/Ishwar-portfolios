...
export default function SkillsSection({ groups }: SkillsSectionProps) {
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_22%_22%,color-mix(in_oklch,var(--chart-1)_16%,transparent),transparent_48%),radial-gradient(circle_at_82%_84%,color-mix(in_oklch,var(--chart-4)_18%,transparent),transparent_56%)]"
      />
      ...
      <BlurFade inView delay={0.08} className="mb-5 rounded-2xl border border-border/70 bg-card/55 p-1.5">
        <Marquee pauseOnHover repeat={3} className="[--duration:28s] [--gap:0.65rem] p-1">
